      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="relative w-full max-w-6xl bg-white rounded-3xl shadow-2xl my-8"
          ...
          >
            ...
            <div className="grid lg:grid-cols-5 gap-0">
              {/* Info Column */}
              <div className="lg:col-span-2 bg-gradient-to-br from-slate-900 via-blue-900 to-violet-900 p-8 md:p-12 rounded-t-3xl lg:rounded-l-3xl lg:rounded-tr-none relative overflow-hidden">
